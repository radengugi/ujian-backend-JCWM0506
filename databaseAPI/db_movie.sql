...
CREATE TABLE `movies` (
  ...
  PRIMARY KEY (`id`),
  KEY `mv_status_idx` (`status`),
  CONSTRAINT `mv_status` FOREIGN KEY (`status`) REFERENCES `movie_status` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `schedules` (
  ...
  PRIMARY KEY (`id`),
  KEY `mv_id_idx` (`movie_id`),
  KEY `mv_location_idx` (`location_id`),
  KEY `mv_time_idx` (`time_id`),
  CONSTRAINT `mv_id` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `mv_location` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `mv_time` FOREIGN KEY (`time_id`) REFERENCES `show_times` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `users` (
  ...
  CONSTRAINT `users_status` FOREIGN KEY (`status`) REFERENCES `status` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'rknnoo','kayla','kayla@mail.com','635e5558e501ad4a05e857d46d7e9465274d04fe34340bf1f2bc35dec0845393',2,1),(2,'4us26c','abdul','abdul@mail.com','ff9e1986af5a01bf167dc98509396ea8b6a9a171fead0b8b7d34e854f0f6a9c1',2,1),(3,'geigd3','gugi','gugi@mail.com','f51be856fd5366ed8694c0c2d2aa764f15d25c2a336db29d88f276c809923acc',1,1),(4,'n1nik5','farid','farid@mail.com','650d060a13b34fbd697ddf14acce91661a9d2261379dcc91d1e17c808e88c210',2,3),(5,'2bib37','isal','isal@mail.com','1a9e5807c091256ab55cdee96147255114a63f4dd43a769473f69671c88fd36d',2,1),(6,'faur0e','rio','rio@mail.com','615da4f554a3a887e19d19a669be40464cbc70d07b40b61e821e61487da6bca9',2,1);
...
-- Dump completed on 2021-06-17 13:12:13
